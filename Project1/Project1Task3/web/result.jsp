...
<html>
    ...
    <body>
        ...
        <h1>The flag of <%= request.getAttribute("country")%></h1><br>
        <img src="<%= request.getAttribute("flagURL")%>"><br><br>
        <strong>About this flag: </strong><%= request.getAttribute("flagDesc") %><br><br>
        Choose another country to display their flag. <br><br>
        <% } else { %> 
        There is no result. <br>
        Please select another one. <br>
        <% }%>
        
        <form action="getFlagDescriptionServlet" method="GET">
        <select name="selected_country" >
            ...
            <option value="../geos/ez.html"> Czechia </option>
